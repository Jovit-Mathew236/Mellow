    ...
    <div>
      ...
      <div className="user-profile-contents">
        <div className="user-profile-banner">
          <p className="banner" style={{ backgroundImage: `url(${'/static/media/user-banner.783996bc.png'})` }}></p>
        </div>
            ...
            return (
              <div className="profile-div" key={index}>
                {userInfo.filter((data) => {
                  ...
                  return (
                    <p key={index} className="profile-pic" style={{ backgroundImage: `url(${info.profilePic})` }}>
